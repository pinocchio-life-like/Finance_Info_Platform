const { postNotice,getNotice,getNoticeById,deleteNotice, findNoticeBYUserId}=require('../../models/noticeBoardModel/association')
    ...
    module.exports={noticePost,noticeGet,noticeGetById,noticeDelete,
        getNoticeByUserC
    }
